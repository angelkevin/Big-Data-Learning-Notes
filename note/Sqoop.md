...
import_data(){
$sqoop import \
--connect jdbc:mysql://centos01:3306/$APP \
--username root \
--password 123456 \
...
hadoop jar /opt/softwares/hadoop-3.1.3/share/hadoop/common/hadoop-lzo-0.4.20.jar com.hadoop.compression.lzo.DistributedLzoIndexer /origin_data/$APP/db/$1/$do_date
}
